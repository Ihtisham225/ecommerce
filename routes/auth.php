...
Route::middleware('guest')->group(function () {
    ...
    Route::post('/login/otp/request', [AuthenticatedSessionController::class, 'requestOtp'])
    ...
    //ajax routes
    Route::post('/ajax/check-email', [AjaxAuthController::class, 'checkEmail'])->name('ajax.checkEmail');
    ...
    Route::post('/ajax/request-otp', [AjaxAuthController::class, 'requestOtp'])->name('ajax.requestOtp');
    Route::post('/ajax/verify-otp', [AjaxAuthController::class, 'verifyOtp'])->name('ajax.verifyOtp');

    Route::get('/check-auth', fn() => response()->json(['authenticated' => Auth::check()]))->name('check.auth');
