<x-app-layout>
            ...
            <div class="relative inline-block align-bottom bg-white dark:bg-gray-800 rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-green-100">Upload WooCommerce CSV file</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form id="importForm" enctype="multipart/form-data" class="bg-white dark:bg-gray-800 px-6 py-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative group">
                            ...
                            <label for="fileInput" 
                                class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl cursor-pointer bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-200 group-hover:border-green-400 group-hover:bg-green-50 dark:group-hover:bg-green-900/20">
                                
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    <svg class="w-8 h-8 mb-3 text-gray-400 group-hover:text-green-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/>
                                    </svg>
                                    <p class="mb-1 text-sm text-gray-500 dark:text-gray-400 group-hover:text-green-600 transition-colors">
                                        <span class="font-semibold">Click to upload</span> or drag and drop
                                    </p>
                                    <p class="text-xs text-gray-400 dark:text-gray-500 group-hover:text-green-500 transition-colors">
                                        CSV files only (.csv)
                                    </p>
                                </div>
                            </label>
                        ...
                        <div id="selectedFile" class="hidden mt-3 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-2">
                                    <svg class="w-4 h-4 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                    </svg>
                                    <span class="text-sm font-medium text-green-800 dark:text-green-300" id="fileName"></span>
                                </div>
                                <button type="button" onclick="clearFileSelection()" class="text-green-600 hover:text-green-800 dark:text-green-400 dark:hover:text-green-300">
                        ...
                        <div class="mt-3 flex items-start space-x-2 text-xs text-gray-500 dark:text-gray-400">
                            ...
                            <p>Make sure your CSV file follows the WooCommerce product export format for best results.</p>
                        </div>
                    </div>
                ...
                <div class="bg-gray-50 dark:bg-gray-700/50 px-6 py-4 flex flex-col sm:flex-row-reverse gap-3 border-t border-gray-200 dark:border-gray-600">
                    ...
                    <button type="button" id="cancelImport" 
                        class="w-full sm:w-auto inline-flex justify-center items-center px-6 py-3 border border-gray-300 dark:border-gray-600 text-base font-medium rounded-xl text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-600 hover:bg-gray-50 dark:hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors duration-200">
                        Cancel
                    </button>
                </div>
            </div>
    ...
    @push('scripts')
        ...
        // ✅ Import Products Modal Logic with Chunk Processing
        $(document).ready(function () {
            ...
            // Configuration
            const uploadUrl = "{{ route('admin.products.import.upload') }}";
            const processUrl = "{{ route('admin.products.import.processChunk') }}";
            ...
            async function uploadAndStart() {
                ...
                try {
                    ...
                    showToast(`Import complete — Processed ${total} product rows.`, 'success');
            ...
            function updateProgress(percent) {
                ...
                if (percent === 100) {
                    ...
                    currentBtn.classList.remove('from-green-500', 'to-emerald-500');
                    currentBtn.classList.add('from-green-600', 'to-emerald-600', 'hover:from-green-700', 'hover:to-emerald-700', 'hover:shadow-xl', 'hover:-translate-y-0.5');
            ...
            function resetImportUI() {
                ...
                // Reset button styles
                startBtn.classList.remove('from-green-500', 'to-emerald-500');
                startBtn.classList.add('from-green-600', 'to-emerald-600', 'hover:from-green-700', 'hover:to-emerald-700', 'hover:shadow-xl', 'hover:-translate-y-0.5');
