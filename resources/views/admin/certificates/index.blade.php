                            ...
                            @forelse($certificates as $certificate)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                    <td class="px-4 py-2 border"> 
                                        ...
                                        <img src="{{ asset('storage/' . $certificate->certificateFile->file_path) }}" alt="{{ $certificate->title }}" class="w-12 h-12 rounded-full"> 
                                        @else 
                                    ...
                                    @role('admin')
                                    <td class="px-4 py-2 border">{{ $certificate->recipient_name ?? '-' }}</td>
                                    @endrole
