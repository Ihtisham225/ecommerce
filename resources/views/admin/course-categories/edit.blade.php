            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                <div class="max-w-4xl mx-auto">
                    ...
                    <div class="p-6 border border-gray-200 border-t-0 rounded-b-lg">
                        <form action="{{ route('admin.course-categories.update', $courseCategory) }}" method="POST" class="space-y-6">
                            @csrf @method('PUT')
                            @include('admin.course-categories.partials.form', ['category' => $courseCategory])
