...
>
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <button
            ...
            :disabled="selected"
            class="flex items-center gap-2 px-4 py-2.5 bg-indigo-600 text-white rounded-lg shadow-sm hover:bg-indigo-700 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:bg-gray-400 disabled:cursor-not-allowed disabled:hover:bg-gray-400"
        >
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
            </svg>
            <span x-text="selected ? 'Customer Added' : 'New Customer'"></span>
        </button>
    </div>
    ...
    <div class="mb-4">
        ...
        <div class="relative">
            ...
            <div x-show="selected" class="absolute inset-y-0 right-0 pr-3 flex items-center">
        ...
        <div class="relative">
            <div 
                x-show="showDropdown && (filtered.length || search.length >= 1) && !selected"
            ...
            >
                <template x-if="filtered.length">
                    <template x-for="cust in filtered" :key="cust.id">
                        ...
                        >
                            <div class="font-medium text-gray-900" x-text="cust.first_name + ' ' + cust.last_name"></div>
    ...
    <template x-if="selected">
        <div class="mt-4 p-4 bg-green-50 rounded-lg border border-green-200 transition-all">
            <div class="flex justify-between items-start">
                <div class="flex-1">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <span class="font-semibold text-gray-900">Customer Assigned to Order</span>
                    </div>
                    <div class="flex items-center gap-2 mb-1">
                        <span class="font-medium text-gray-900" x-text="selected.first_name + ' ' + selected.last_name"></span>
                    </div>
                ...
                <button 
                    class="text-red-600 hover:text-red-800 p-1 rounded transition-colors flex-shrink-0 ml-2"
    ...
    <div 
        x-show="showCreateModal && !selected"
        x-cloak
    ...
    <div 
        ...
        :class="{
            'bg-green-50 text-green-800 border border-green-200': message && message.type === 'success',
            'bg-red-50 text-red-800 border border-red-200': message && message.type === 'error'
        }"
    >
        <div class="flex items-center" x-show="message && message.text">
            ...
            <span x-text="message ? message.text : ''"></span>
        </div>
    </div>
...
<script>
    function customerManager(orderId) {
        return {
            ...
            // FIXED: Properly initialize message object
            message: {
                text: "",
                type: "success"
            },
            ...
            searchCustomers() {
                if (this.search.length < 1 || this.selected) {
                    this.filtered = [];
                    this.showDropdown = false;
                    return;
                }
            ...
            selectCustomer(cust) {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        // Dispatch event to parent form with customer AND address data
            ...
            removeCustomer() {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        // Method 2: Dispatch with detail (in case it needs data)
                        this.$dispatch('customer-removed', { removed: true });
            ...
            createCustomer() {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        // Also assign the customer to the order and get addresses
                        fetch(`/admin/orders/${orderId}/customer/select`, {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
                        ...
                        .then(orderData => {
                            if (orderData.success) {
                                // Dispatch event to parent form with new customer AND address data
                                this.$dispatch('customer-selected', { 
