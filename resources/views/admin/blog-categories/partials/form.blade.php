            ...
            <div class="grid grid-cols-1 gap-6">
                <div class="bg-gray-50 p-4 rounded-lg dark:bg-gray-700">
                    ...
                    <input type="text" name="name_en" id="name_en" 
                        value="{{ old('name_en', $blogCategory->name_en ?? '') }}"
                ...
                <div class="bg-gray-50 p-4 rounded-lg dark:bg-gray-700">
                    ...
                    <textarea name="description_en" id="description_en" rows="4"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm 
                               focus:border-indigo-500 focus:ring-indigo-500 
                               dark:bg-gray-600 dark:text-white dark:border-gray-500 
                               p-2 border">{{ old('description_en', $blogCategory->description_en ?? '') }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 gap-6">
                <div class="bg-gray-50 p-4 rounded-lg dark:bg-gray-700">
                    ...
                    <input type="text" name="name_ar" id="name_ar" 
                        value="{{ old('name_ar', $blogCategory->name_ar ?? '') }}"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm 
                               focus:border-indigo-500 focus:ring-indigo-500 
                               dark:bg-gray-600 dark:text-white dark:border-gray-500 
                ...
                <div class="bg-gray-50 p-4 rounded-lg dark:bg-gray-700">
                    ...
                    <textarea name="description_ar" id="description_ar" rows="4" dir="rtl"
                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm 
                               focus:border-indigo-500 focus:ring-indigo-500 
                               dark:bg-gray-600 dark:text-white dark:border-gray-500 
                               p-2 border">{{ old('description_ar', $blogCategory->description_ar ?? '') }}</textarea>
                </div>
            </div>
        </div>
    </div>
